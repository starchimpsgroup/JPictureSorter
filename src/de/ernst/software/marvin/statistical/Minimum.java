package de.ernst.software.marvin.statistical;

<html><head><title>Encountered a 404 error</title>
<body>
<p>An error has been encountered in accessing this page.
<p>1. <b>Server:</b> marvinproject.sourceforge.net
<br />2. <b>URL path:</b> /sourceCodes/plugins/image/statistical/mode/Minimum.java
<br />3. <b>Error notes:</b> NONE
<br />4. <b>Error type:</b> 404
<br />5. <b>Request method:</b> GET
<br />6. <b>Request query string:</b> NONE
<br />7. <b>Time:</b> 2012-02-26 15:32:19 UTC (1330270339)
...
<ol><li>Contact the project via their <a href="http://sourceforge.net/support/prweb-lookup.php?host=marvinproject.sourceforge.net&support=1">designated support resources</a>.
<li>Contact the project administrators of this project via email (see the upper right-hand corner of the <a href="http://sourceforge.net/support/prweb-lookup.php?host=marvinproject.sourceforge.net">Project Summary page</a> for their usernames) at <i>user-name</i>@users.sourceforge.net</ol>
